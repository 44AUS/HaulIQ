      ...
      <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 0, minWidth: 900 }}>
        ...
        <tbody>
          {loads.map(load => {
            ...
            return (
              <tr key={load.id} className="ion-activatable" onClick={() => navigate(`/carrier/loads/${load.id}`, { state: { from: 'Load Board' } })} style={{ cursor: 'pointer', height: 64, position: 'relative', overflow: 'hidden' }}><IonRippleEffect />
